package org.replica.ecommerce.aop;
...
import org.replica.ecommerce.business.services.AuditTrailService;
...
public class LoggerAspect {
    ...
    @Around("@annotation(org.replica.ecommerce.aop.annotation.Auditor)")
