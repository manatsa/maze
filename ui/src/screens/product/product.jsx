...
import ViewUserDialog from "../admin/view.user.dialog.jsx";
...
const Product =  () => {
    ...
    useEffect(()=>{
        let prods=data?.map(d=>{
            return {...d,userName:d?.createdBy?.userName,category:d?.category?.name,ownerFull:d?.owner, owner:d?.owner?.userName, industry:d?.category?.industry?.name, ownerName: d?.owner?.firstName+' '+d?.owner?.lastName};
        })
                    ...
                    <div className="flex col-12 flex-row sx:flex-column justify-content-between " >
                        ...
                        <div className="flex flex-column sm:flex-row justify-content-between align-items-center xl:align-items-start flex-1 gap-4">
                            ...
                            <div className="flex flex-row sm:flex-column align-items-center sm:align-items-end gap-3 sm:gap-2">
                                ...
                                <span className="text-sm text-blue-800"><a href={'#'} onClick={()=>{
                                    setOwner(product?.ownerFull);
    ...
    const onSelectCategory=(e,category)=>{
        let prodList=products?.filter(p=>{
        ...
        <>
            ...
            <div className="grid">
                <div className="col col-12">
                        ...
                        <div className="card flex flex-row">
                            <div className="col-5 md:col-3 pt-5">
            ...
            >
                <div className={'flex justify-content-between'}>
                    <span>{`CART ITEMS`}</span><span>{'TOTAL: $'+(cartTotal?.toFixed(2)?.toLocaleString("en-US"))}</span>
                </div>
            </div>}visible={showCartItems} onHide={() => setShowCartItems(false)} style={{ width: '50vw' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
            ...
            }} visible={showProductOwner} style={{ width: '60vw' }} sx={{width:'100%'}} onHide={() => setShowProductOwner(false)}>
                <ViewUserDialog setShowViewUserDialog={setShowProductOwner} user={owner}/>
            </Dialog>
